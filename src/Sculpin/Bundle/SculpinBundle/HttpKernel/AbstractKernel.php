...
if (version_compare(PHP_VERSION, '8.2.0', '>=')) {
    ...
    // PHP 8.1 + Symfony HttpKernel v6.4 results in AbstractKernel::getProjectDir's return type being "string",
    // and not "?string". This bifurcation of AbstractKernel based on PHP version is quite unpleasant, but
    // is just a temporary band-aid until Sculpin 4.x
    require_once 'AbstractKernel.php81.php';
}
